...
propertyController.get('/find/types', async(req,res)=>{
    try{
        const beachType= await Property.countDocuments({type:'agra'})
        const mountainType= await Property.countDocuments({type:'kota'})
        const villageType= await Property.countDocuments({type:'noida'})
